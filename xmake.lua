...
add_requires("yaml_cpp_struct", "nlohmann_json", "spdlog", "inja")
add_requires("boost", "plusaes")
...
target("cpp-freegpt-webui")
    set_kind("binary")
    add_files("src/*.cpp")
    add_packages("openssl", "yaml_cpp_struct", "nlohmann_json", "spdlog", "boost", "inja", "plusaes")
